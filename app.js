...
const FIRE_CARGO_DATA = [
  {
    ...
    accidents: [
      '2020 베이루트항 질산암모늄(산화성 5.1) 2,750t 폭발 — 항만·도심 궤멸, 200여 명 사망·수천 명 부상. 폭발성/산화성 화물 보관·관리 실패가 부른 최악의 항만 폭발 사례.',
      '2015 중국 톈진항 위험물 창고 대폭발 — 질산암모늄·시안화물 등 혼적·관리 부실로 대규모 폭발·화재, 170여 명 사망. 위험물 분리·신고 관리의 중요성을 보여줌.'
    ],
    manage: [
      'Class 1 전용 신고·승인·전용 적재구역 격리, 점화원·충격·정전기 차단.',
      '정확한 등급(1.1~1.6)·적합성그룹 확인, 오신고·위장 적발 시 즉시 반입 거부.'
    ],
